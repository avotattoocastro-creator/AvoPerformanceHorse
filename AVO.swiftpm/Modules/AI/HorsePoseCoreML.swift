...
final class HorsePoseCoreML {
    ...
    private func bundledModelURL() -> URL? {
        // App Store / Codemagic safe: only use a precompiled .mlmodelc deliberately bundled in the app.
        // Broken training artefacts (.pt/.onnx/.mlpackage/best/model) are intentionally ignored here and can
        // still be imported by the user into Documents/Models after installation.
