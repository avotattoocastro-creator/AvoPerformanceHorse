...
struct AVOLiveTrainingDashboardPage: View {
    ...
    private var rtkFixLabel: String {
        ...
        if vestIsServerFrozen || isDashboardDataFrozen { return "FROZEN" }
    ...
    private var rtkSignalColor: Color {
        if vestIsServerDisconnected { return .red }
        if vestIsServerFrozen || isDashboardDataFrozen { return .orange }
    ...
    private var connectionStatusText: String {
        if vestIsServerDisconnected { return "VEST\nDISCONNECTED" }
        if vestIsServerFrozen || isDashboardDataFrozen { return "DATA\nFROZEN" }
    ...
    private var sessionStatusText: String {
        if vestIsServerDisconnected || vestIsServerFrozen || isDashboardDataFrozen { return "SESSION STOP" }
