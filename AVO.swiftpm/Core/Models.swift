...
struct TrainingZone: Codable {
    ...
    var fixedCameraLatitudeDelta: Double
    var fixedCameraLongitudeDelta: Double

    init(name: String, latitude: Double, longitude: Double, radiusMeters: Double, polygon: [TrainingZonePoint] = [], fixedCameraLatitudeDelta: Double = 0.006, fixedCameraLongitudeDelta: Double = 0.006) {
        self.name = name
        self.latitude = latitude
        self.longitude = longitude
        self.radiusMeters = radiusMeters
        self.polygon = polygon
        self.fixedCameraLatitudeDelta = fixedCameraLatitudeDelta
        self.fixedCameraLongitudeDelta = fixedCameraLongitudeDelta
    }

    enum CodingKeys: String, CodingKey {
        case name, latitude, longitude, radiusMeters, polygon, fixedCameraLatitudeDelta, fixedCameraLongitudeDelta
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        fixedCameraLatitudeDelta = try container.decodeIfPresent(Double.self, forKey: .fixedCameraLatitudeDelta) ?? 0.006
        fixedCameraLongitudeDelta = try container.decodeIfPresent(Double.self, forKey: .fixedCameraLongitudeDelta) ?? 0.006
    }
